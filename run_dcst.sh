...
# ##model_path="ud_parser_san_2020.03.15-00.49.49"
...
for task in 'number_of_children' 'relative_pos_based' 'distance_from_the_root'; do
	...
	--tag_space 128 --num_layers 3 --num_filters 100 --use_char  --char_dim 100 --use_pos \
...
python examples/GraphParser.py --dataset ud --domain $domain --rnn_mode LSTM \
--num_epochs $num_epochs --batch_size 16 --hidden_size 512 --use_pos \
