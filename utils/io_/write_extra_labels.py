...
def Multitask_case_predict(model_path, parser_path, src_domain, tgt_domain, use_unlabeled_data=True, use_labeled_data=True):
    ...
    writing_paths['train'] = 'data/Multitask_case_predict_train_san'
    writing_paths['dev'] = 'data/Multitask_case_predict_dev_san'
    writing_paths['test'] = 'data/Multitask_case_predict_test_san'
    return writing_paths
